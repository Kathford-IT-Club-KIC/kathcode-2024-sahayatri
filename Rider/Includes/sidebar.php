<!-- sidebar.php -->
<div class="h-full bg-gray-800 text-white w-56 p-4 fixed top-0 left-0 overflow-y-auto">
    <!-- Sidebar Brand -->
    <a href="createPoolRequest.php" class="flex items-center justify-center mb-8">
    ...
    <ul class="space-y-2">
        ...
        <li>
            <a href="myPoolAlerts.php" class="block px-4 py-2 rounded hover:bg-gray-700 border-b border-gray-700">My Pool Alerts</a>
        </li>
    </ul>
</div>
