...
<nav class="bg-gray-800 text-white w-full p-4 flex items-center justify-between">
    ...
    <ul class="flex items-center justify-center w-full space-x-4">
        ...
        <li>
            <input type="text" class="px-2 py-1 rounded-md bg-white text-gray-800 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="No. of Seats" required id='appliedSeats'>
        </li>
    </ul>
